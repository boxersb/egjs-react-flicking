  ...
  public render() {
    return (
      <div id="progress" className="container">
        ...
        <ul className="extra">
          <li>
            When panel is completely invisible, outsetProgress becomes -1 at
            left(up), 1 at right(down) direction, and 0 when panel's anchor and
            hanger is overlapped.
          </li>
        </ul>
        <Flicking
          ...
          onMove={e => {
            ...
            flicking.getAllPanels(true).forEach(panel => {
              panel.getElement().innerHTML = panel
                .getOutsetProgress()
                .toFixed(2);
            });
          }}
        ...
        <ul className="extra">
          <li>
            Indicates the percentage of areas within the viewport that the panel
            occupies.
          </li>
        </ul>
        <Flicking
        ...
        <div className="pagination pagination3" />
        <pre>
          <code className="hljs html" data-script="flicking3" />
        </pre>
      </div>
    );
  }
