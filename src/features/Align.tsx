    ...
    return (
      <div id="align" className="container">
        ...
        <ul className="extra">
          ...
          <li>
            The Hanger and Anchor have magnetically bonded effect which allows
            the panel position to be aligned
          </li>
          <li>
            <strong>Hanger:</strong> An alignment point within Flicking area. It
            hangs panel anchors to its position.
          </li>
          <li>
            <strong>Anchor:</strong> Alignment points based on each panels.
            Panel's anchor position is determined by this value. <br /> It will
            be used for a reference point where panel should stop when selected,
            interacting with hanger position.
          </li>
        </ul>
        <h2>Center Align (Default)</h2>
        <h3>hanger: 50%, anchor: 50%</h3>
        <div className="hanger hanger0" />
