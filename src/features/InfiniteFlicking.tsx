  ...
  public render() {
    ...
    return (
      <div id="infinite" className="container">
        ...
        <ul className="extra">
          <li>
            Enabling the infinite option can make <strong>needPanel</strong>{" "}
            event to be triggered when more panels at moving direction should be
            fetched within <strong>infiniteThreshold</strong> value.
          </li>
        </ul>
        <Flicking
